          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                ...
                <a
                  href="/lab-assistant-dashboard/patient-register"
                ...
                <a
                  href="/lab-assistant-dashboard/upload-scan"
                  className="flex items-center gap-2 w-full bg-white p-3 rounded-lg border hover:bg-gray-50 transition"
                >
        ...
        <div className="bg-purple-200 p-4 rounded-xl max-w-md">
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-2">
              <input type="checkbox" /> Confirm AI result
            </label>
            <label className="flex items-center gap-2">
              <input type="checkbox" /> Request Re-scan
            </label>
          </div>
        </div>
      </main>
