...
function LabAssistantLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/lab_assistant/login", {
        method: "POST",
        body: formData,
      });
    ...
    setTimeout(() => {
        // redirect
        window.location.href = "/lab-assistant-dashboard/labassistant";
            }, 500);
      }
    } catch (err) {
      ...
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          ...
          <p className="text-center mt-6 text-sm text-gray-500">
            ...
            <a className="text-blue-500" href="/lab-assistant-register">
              Sign up
            </a>
          </p>
        </div>
