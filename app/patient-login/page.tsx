  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setTimeout(() => {
          window.location.href = "/patient-dashboard/dashboard";
        }, 500);
      }
    } catch (err) {
      ...
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="flex items-center justify-center gap-3 border border-gray-300 bg-purple-500 hover:bg-purple-700 py-3 rounded-full w-full transition shadow-sm"
          >
          ...
          <p className="text-center mt-6 text-sm text-gray-500">
            ...
            <a className="text-blue-500" href="/patient-register">
              Sign up
            </a>
          </p>
        </div>
